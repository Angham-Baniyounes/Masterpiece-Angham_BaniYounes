...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="grow touch, admin,dashboard">
        <meta name="author" content="stacks">
        <!-- The above 6 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        
        <!-- Title -->
        <title>Grow Touch - Admin Login</title>
        ...
        <link href="{{asset('/dashboard/css/admin3.css')}}" rel="stylesheet">
        ...
        <link href="{{asset('/dashboard/css/layout_style.css')}}" rel="stylesheet">
    </head>
    <body class="auth-page sign-in bg-login">
